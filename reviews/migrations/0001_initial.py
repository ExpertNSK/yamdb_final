# Generated by Django 2.2.16 on 2022-06-17 19:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'user'), ('moderator', 'moderator'), ('admin', 'administrator')], default='user', max_length=13, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('genre', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='genre', to='reviews.Genre', verbose_name='Название жанра')),
            ],
        ),
        migrations.CreateModel(
            name='Title',
        ...
        migrations.AddField(
            ...
            name='title',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='title', to='reviews.Title', verbose_name='Название произведения'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
